...
Rakyll.dsl root_path: 'ryosai2019', watch: ARGV.include?('--watch') do
  copy 'assets/*'
  copy 'data/*.png'
...
Rakyll.dsl root_path: 'ryosai2019/events', watch: ARGV.include?('--watch') do
